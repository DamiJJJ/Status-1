...
`python3 tools/gen_badge.py` (a PNG read from disk is cross-origin under
`file://` and would throw inside `texImage2D`). Everything else (textures,
sounds, music, geometry, logo) is generated by this repository.
